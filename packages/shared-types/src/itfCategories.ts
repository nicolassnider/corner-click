...
export const WORLD_CHAMPIONSHIP_AGES: AgeGroupDef[] = [
  {
    ...
    minAge: 12,
    maxAge: 14,
    maleWeights: preJuniorMaleWeights,
    femaleWeights: preJuniorFemaleWeights,
  },
  {
    name: "Junior",
    minAge: 15,
    maxAge: 17,
    maleWeights: juniorMaleWeights,
    femaleWeights: juniorFemaleWeights,
  },
  {
    name: "Adulto",
    minAge: 18,
    maxAge: 99,
    maleWeights: adultMaleWeights,
    femaleWeights: adultFemaleWeights,
  },
];
...
export const WORLD_CUP_AGES: AgeGroupDef[] = [
  ...
  },
  {
    ...
    minAge: 36,
    maxAge: 45,
    maleWeights: seniorMaleWeights,
    femaleWeights: seniorFemaleWeights,
  },
  {
    name: "Veterano",
    minAge: 46,
    maxAge: 99,
    maleWeights: veteranMaleWeights,
    femaleWeights: veteranFemaleWeights,
  },
];
...
export const LOCAL_AGES: AgeGroupDef[] = [
  {
    ...
    minAge: 4,
    maxAge: 5,
    maleWeights: childrenWeights,
    femaleWeights: childrenWeights,
  },
  {
    name: "Pre-Mini",
    minAge: 6,
...
export const getBeltsForAgeGroup = (
  ...
  if (tournamentType === "LOCAL_OPEN") {
    ...
    if (
      ageGroupName !== "Micro" &&
      ageGroupName !== "Pre-Mini" &&
      ageGroupName !== "Mini" &&
      ageGroupName !== "Infantil"
    ) {
