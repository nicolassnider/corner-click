...
export default function AnalyticsFooter() {
  return (
    <footer className="w-full py-8 bg-gray-900 border-t border-gray-800 mt-auto print:hidden">
      <div className="max-w-[95vw] 2xl:max-w-[1700px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-gray-400 font-medium tracking-wide text-sm italic">"{APP_MOTTO}"</p>
