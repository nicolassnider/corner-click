...
export default function ScorePad({
  ...
  const handleDeductionTouchStart = (
    color: CornerRole,
    e: React.TouchEvent,
  ) => {
    // e.preventDefault();
      ...
      <div className="flex-none bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/80 shadow-2xl z-20 pb-4 relative pt-2">
        <div className="flex items-center justify-between px-6 py-2">
          ...
          <div className="flex flex-col items-center w-[40%]">
            <span className="text-rose-500 font-black tracking-widest text-xs mb-1">
              ROJO
            </span>
          ...
          {/* Blue Score */}
          <div className="flex flex-col items-center w-[40%]">
            <span className="text-blue-500 font-black tracking-widest text-xs mb-1">
              AZUL
            </span>
      ...
      <div className="flex-1 flex w-full relative z-10 p-2 gap-2">
        ...
        <div className="flex-1 flex flex-col gap-2 relative">
          ...
          <div className="flex gap-2 mt-1 flex-[1.5]">
            ...
            <button
              onTouchStart={(e) =>
                handleDeductionTouchStart(CornerRole.BLUE, e)
              }
