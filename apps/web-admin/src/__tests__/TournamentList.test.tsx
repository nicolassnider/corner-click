...
describe('TournamentList Component', () => {
  ...
  it('should display loading spinner initially, then show tournaments divided by state', async () => {
    ...
    render(<TournamentList onSelect={onSelect} onCreateNew={onCreateNew} onEdit={onEdit} />)
  ...
  it('should hide Edit and Delete buttons for completed tournaments and show them for active ones', async () => {
    ...
    render(<TournamentList onSelect={vi.fn()} onCreateNew={vi.fn()} onEdit={vi.fn()} />)
  ...
  it('should call onSelect when a tournament card is clicked', async () => {
    ...
    const onSelect = vi.fn()
    render(<TournamentList onSelect={onSelect} onCreateNew={vi.fn()} onEdit={vi.fn()} />)
  ...
  it('should call onEdit when Edit button is clicked', async () => {
    ...
    const onEdit = vi.fn()
    render(<TournamentList onSelect={vi.fn()} onCreateNew={vi.fn()} onEdit={onEdit} />)
  ...
  it('should handle Delete tournament correctly when confirmed', async () => {
    ...
    ;(fetchWithAuth as any).mockImplementation((_url: string, init?: any) => {
