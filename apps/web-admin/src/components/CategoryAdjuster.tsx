...
export const CategoryAdjuster: React.FC<CategoryAdjusterProps> = ({
  ...
  const competitorCounts = categories.reduce(
    (acc, cat) => {
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
        ...
        {loading ? (
          <div className="py-12 text-center text-gray-500">
            Cargando categorías y competidores...
          </div>
          ...
          <div className="relative overflow-x-auto max-h-96 overflow-y-auto border border-gray-200 rounded-lg">
            {merging && (
              <div className="absolute inset-0 bg-white/60 backdrop-blur-sm flex items-center justify-center z-10">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-indigo-800 font-semibold">Fusionando categorías...</span>
                </div>
              </div>
            )}
